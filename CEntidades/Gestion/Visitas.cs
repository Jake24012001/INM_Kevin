...
namespace CEntidades.Gestion
{
    public class Visitas
    {
        ...
        public Visitas(int idVisitas, DateTime fechaV, TimeSpan horaV, int idUsuario, string comentario) : this(idVisitas)
        {
            this.fechaV = fechaV;
            this.horaV = horaV;
        ...
        public TimeSpan HoraV { get => horaV; set => horaV = value; }
